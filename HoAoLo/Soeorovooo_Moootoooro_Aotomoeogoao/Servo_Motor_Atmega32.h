...
////////////////////////////////////////////////////////////////
	...
	void Servo_Motor_Rotate_In_Degrees(INT32U);//e.g. Servo_Motor_Rotate_In_Degrees(num_of_degrees,direction);

	void Servo_Motor_Get_Angle_From_Uart(void);//e.g. Servo_Motor_Get_Angle_From_Uart();
////////////////////////////////////////////////////////////////
